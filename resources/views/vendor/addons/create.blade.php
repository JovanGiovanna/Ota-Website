...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('vendor.addons.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="url" name="image_url" id="image_url" value="{{ old('image_url') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                @error('image_url')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
