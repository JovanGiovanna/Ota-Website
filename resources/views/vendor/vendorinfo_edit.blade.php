...
@section('title', 'Edit Vendor Information')
...
<div class="px-6 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Edit Vendor Information</h1>
            <a href="{{ route('vendor.profile') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg font-medium">
                Back to Profile
            </a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-6">
                <form action="{{ route('vendor.info.update') }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name_corporate" id="name_corporate" value="{{ old('name_corporate', $vendorInfo->name_corporate) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" id="phone" value="{{ old('phone', $vendorInfo->phone) }}" required
                                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500">
                                @error('phone')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="id_city" id="id_city" required
                                    ...
                                    @foreach($cities as $city)
                                        <option value="{{ $city->id }}" {{ old('id_city', $vendorInfo->id_city) == $city->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" step="any" name="coordinate_latitude" id="coordinate_latitude" value="{{ old('coordinate_latitude', $vendorInfo->coordinate_latitude) }}" required
                                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500">
                            ...
                            <div>
                                ...
                                <input type="number" step="any" name="coordinate_longitude" id="coordinate_longitude" value="{{ old('coordinate_longitude', $vendorInfo->coordinate_longitude) }}" required
                                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500">
                    ...
                    <!-- Landmark -->
                    <div>
                        <label for="landmark_description" class="block text-sm font-medium text-gray-700">Landmark Description</label>
                        <textarea name="landmark_description" id="landmark_description" rows="3"
                                  class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500">{{ old('landmark_description', $vendorInfo->landmark_description) }}</textarea>
