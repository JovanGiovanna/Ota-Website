    ...
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('vendor.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <textarea name="address" id="address" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('address', $product->address) }}</textarea>
            ...
            <div class="mb-4">
                ...
                <select name="refund_policy" id="refund_policy" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="mendukung" {{ old('refund_policy', $product->refund_policy ?? 'mendukung') == 'mendukung' ? 'selected' : '' }}>Mendukung (User dapat refund saat booking)</option>
                    <option value="tidak mendukung" {{ old('refund_policy', $product->refund_policy) == 'tidak mendukung' ? 'selected' : '' }}>Tidak Mendukung (User tidak dapat refund saat booking)</option>
                </select>
                @error('refund_policy')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
