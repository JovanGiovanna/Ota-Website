...
@section('title', 'Transaction Products')
...
<div class="px-6 py-8">
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Product Transactions</h1>
    </div>
        ...
        <div class="p-6">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $transaction->product->name ?? 'N/A' }}</td>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Product transactions will appear here.</p>
                </div>
            @endif
        </div>
    </div>
