                    ...
                    <nav class="flex-1 px-4 space-y-2">
                        ...
                        <div class="px-2 py-2">
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="{{ route('super_admin.system_settings') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                                    <svg class="text-gray-400 group-hover:text-gray-300 mr-3 flex-shrink-0 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
