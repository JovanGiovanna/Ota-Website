                    ...
                    @forelse($packages as $package)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <form method="POST" action="{{ route('super_admin.packages.destroy', $package) }}" style="display: inline;" class="inline-block" data-delete-item="package: {{ $package->name_package }}" onsubmit="return confirmDeleteAction(this)">
                                    @csrf
                                    @method('DELETE')
