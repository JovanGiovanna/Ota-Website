...
<div class="px-4 py-6 sm:px-0">
    <div class="max-w-md mx-auto bg-white shadow overflow-hidden sm:rounded-md">
        <div class="px-4 py-5 sm:px-6">
            ...
            <p class="mt-1 max-w-2xl text-sm text-gray-500">Update category information</p>
        </div>

        <form method="POST" action="{{ route('super_admin.categories.update', $category) }}" class="px-4 py-5 sm:px-6 space-y-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="categories" id="categories" value="{{ old('categories', $category->categories) }}" required
