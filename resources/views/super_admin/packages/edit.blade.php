...
<div class="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        ...
        <form id="package-form" action="{{ route('super_admin.packages.update', $package) }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 shadow-xl rounded-xl border border-gray-200">
            @csrf
