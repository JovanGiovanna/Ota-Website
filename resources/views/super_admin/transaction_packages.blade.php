            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">Premium Package</div>
                            <div class="text-sm text-gray-500">Photography + Video</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">Basic Package</div>
                            <div class="text-sm text-gray-500">Photography Only</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">Deluxe Package</div>
                            <div class="text-sm text-gray-500">Full Wedding Coverage</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div class="text-sm font-medium text-gray-900">Rp 3,000,000</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
