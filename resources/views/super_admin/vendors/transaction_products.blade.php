...
@section('title', 'Vendor Product Transactions - ' . $vendor->name)

@section('welcome')
Vendor Product Transactions Management
@endsection
...
<div class="px-4 py-6 sm:px-0">
    <div class="bg-white shadow overflow-hidden sm:rounded-md">
        <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
            <div>
                <h3 class="text-lg leading-6 font-medium text-gray-900">Product Transactions for {{ $vendor->name }}</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">View all product transactions for this vendor</p>
            </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center text-gray-500">
                            No product transactions found for this vendor.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
