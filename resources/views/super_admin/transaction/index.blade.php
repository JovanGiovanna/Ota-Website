@extends('layouts.superadmin') {{-- Copied from admin transaction index --}}

@section('title', 'Booking Transactions & Approval (Super Admin)')
                ...
                <div class="text-right flex-shrink-0">
                    ...
                    <div class="mt-3 flex flex-col space-y-2">
                        ...
                        @if($booking->status == 'paid')
                            <form action="{{ route('super_admin.transaction.verify_payment', $booking) }}" method="POST" onsubmit="return confirm('Verifikasi pembayaran dan tandai sebagai completed?');">
                                @csrf
                        ...
                        @if($booking->status == 'payment_return')
                            <form action="{{ route('super_admin.transaction.process_refund', $booking) }}" method="POST" onsubmit="return confirm('Proses pengembalian dana dan tandai selesai?');">
                                @csrf
